...
typedef void VOID;
/* @INV_JORYL
 * Hey Subin. We're gonna put it back now that we don't define it elsewhere.
 * KTHXBYE.
 * --- Joryl Calizo (3/21/2012)
 */
/* @GESL
 * I know I am not supposed to edit this. But this has been defined previously
 * to unsigned int. Also no other USB related files seems to use this. Anyway
 * unsigned long and unsigned int are not very different..
 * --- Subin P Thomas (12/15/2011)
 */
